...
class BuildPrompt(CodedTool):
    ...
    def __init__(self):
        ...
        self.docs_path = {
            "orders": "coded_tools/postgres_agent/resources/gold_fact_orders.json",
            "customers": "coded_tools/postgres_agent/resources/gold_dim_customer.json",
            "customer_360": "coded_tools/postgres_agent/resources/gold_customer_360_spine_v1.json",
            "master_data_worker": "coded_tools/postgres_agent/resources/customer_360.json",
        }
